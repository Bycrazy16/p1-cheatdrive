...
const int DIM_RIGA = 80 + 1;				// Per semplicita' si assuma che ogni riga del file di input abbia una lunghezza di al piu' 80 caratteri
...
int main(int argc, char* argv[]) {
	...
	char riga[DIM_RIGA];					// crea un array per contenere le righe
	...
	// CREO LE RIGHE E LE LASCIO IN UN LIMBO
	...
	// SALVO SOLO QUELLE CHE MI INTERESSANO NEL FIL DI OUTPUT
